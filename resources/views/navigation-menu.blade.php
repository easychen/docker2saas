        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('plans.list') }}" :active="request()->routeIs('plans.*')">
                        {{ __('Plans') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link href="{{ route('droplets') }}" :active="request()->routeIs('droplets')">
                        {{ __('Droplets') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('subscribe.mine') }}" :active="request()->routeIs('subscribe.*')">
                        {{ __('Subscriptions') }}
                    </x-jet-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                @if( $str = show_expire_date( Auth::user()->subscription_expire_date ) )
                <span class="rounded px-2 py-1 font-mono bg-yellow-600 text-white text-xs">{{ $str }}</span>
                @else
                <span class="rounded px-2 py-1 font-mono bg-gray-300 text-white text-xs">expired</span>
                @endif
